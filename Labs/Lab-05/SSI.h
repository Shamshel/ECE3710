...
//base addresses
#define SSI0 (unsigned int*)0x40008000
#define SSI1 (unsigned int*)0x40009000
#define SSI2 (unsigned int*)0x4000A000
#define SSI3 (unsigned int*)0x4000B000
...
#define RCGCSSI (unsigned int*)0x400FE61C
