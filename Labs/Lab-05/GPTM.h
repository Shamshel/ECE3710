...
//base addresses
#define GPTM0 ((unsigned int*) 0x40030000)
#define GPTM1 ((unsigned int*) 0x40031000)
#define GPTM2 ((unsigned int*) 0x40032000)
#define GPTM3	((unsigned int*) 0x40033000)
...
void initGPTM_EdgeCount(unsigned int* gptmBaseAddr, unsigned int timeout, unsigned int irqMask);
void initGPTMA_Periodic(unsigned int* base, unsigned int timeout, unsigned int irqMask);
